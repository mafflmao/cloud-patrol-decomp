...
public class UIButton3D : ControlBase
{
	...
	public List<POINTER_INFO.INPUT_EVENT> whenToInvoke = new List<POINTER_INFO.INPUT_EVENT>(new POINTER_INFO.INPUT_EVENT[2]
	{
		POINTER_INFO.INPUT_EVENT.TAP,
		POINTER_INFO.INPUT_EVENT.RELEASE
	});
	...
	public override void OnInput(ref POINTER_INFO ptr)
	{
		...
		else if (!whenToInvoke.Contains(ptr.evt))
		{
			return;
		}
		if (whenToInvoke.Contains(ptr.evt) && soundOnClick != null)
		{
