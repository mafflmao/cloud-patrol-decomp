...
public class UIScrollKnob : UIButton
{
	...
	protected Vector3 offsetCollider;
	...
	public void SetColliderSizeFactor(Vector2 csf, Vector3 offset)
	{
	...
	public override void UpdateCollider()
	{
		...
		if (base.GetComponent<Collider>() is BoxCollider && !IsHidden())
		{
			...
			boxCollider.center = new Vector3(boxCollider.center.x + offsetCollider.x, boxCollider.center.y + offsetCollider.y, boxCollider.center.z + offsetCollider.z);
		}
	}
