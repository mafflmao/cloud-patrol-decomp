...
public class TolerantMultifingerDragGestureRecognizer : AveragedGestureRecognizer
{
	...
	public event EventDelegate<TolerantMultifingerDragGestureRecognizer> OnDragBegin;

	public event EventDelegate<TolerantMultifingerDragGestureRecognizer> OnDragMove;

	public event EventDelegate<TolerantMultifingerDragGestureRecognizer> OnDragEnd;
