...
public class PackedSprite : AutoSpriteBase
{
	...
	protected override void Awake()
	{
		...
		base.Awake();
		if (m_spriteMesh != null && ((SpriteMesh)m_spriteMesh).MRAtlasIndex != -1 && staticTexGUID.Length > 0)
		{
			Vector2[] array = new Vector2[4];
			staticFrameInfo.uvs.x = array[0].x;
			staticFrameInfo.uvs.y = array[1].y;
			staticFrameInfo.uvs.width = array[2].x - array[1].x;
			staticFrameInfo.uvs.height = array[0].y - array[1].y;
		}
		Init();
	}
